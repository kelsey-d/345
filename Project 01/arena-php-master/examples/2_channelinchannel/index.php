...
$arena = new Arena();
$slug = 'archive_site'; // channel slug (e.g. http://are.na/interesting-menu)
        ...
        <div class="item <?= $item->css_class()?>">
          ...
          <div class="blog-content">
            ...
            <?php if($item->is_channel()){ ?>
              ...
              <!-- For channels, we pass the slug of the channel to a separate file -->
              <!-- called view.php, which takes the slug as a $_GET parameter and -->
